...
\title{\textbf{Network Security Assignment 6:\\ Network Telescope Analysis}}
...
\autoref{tab:scanners} presents the ten most active scanning sources observed in the dataset. These IP addresses represent the most prolific attackers, with the top two sources accounting for nearly 15\% of all traffic combined.
...
\midrule
88.213.209.194 & 7,598 & 7.72\% \\
185.242.226.50 & 7,148 & 7.27\% \\
192.241.217.10 & 2,965 & 3.01\% \\
192.241.223.55 & 2,945 & 2.99\% \\
45.14.226.132 & 1,759 & 1.79\% \\
45.33.110.79 & 1,161 & 1.18\% \\
80.75.212.37 & 1,135 & 1.15\% \\
8.138.99.185 & 1,025 & 1.04\% \\
...
The distribution shows a clear power-law pattern where a small number of sources generate the majority of scanning traffic. This concentration suggests organized scanning campaigns rather than distributed individual attacks.

\section{Target Port Analysis}
The following tables analyze the most frequently targeted ports, separated by protocol type to understand attacker preferences and potential objectives.
