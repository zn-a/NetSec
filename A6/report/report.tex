...
\autoref{tab:heavyhitter} shows the scanner that sent the most packets. It was responsible for over 188,000 TCP SYN and UDP packets. This scanner targeted 5,782 unique IP addresses and 43 different ports. GeoIP lookup indicates it originated from the Netherlands (country code \texttt{NL}), suggesting potential use of a hosting provider for broad automated scans.
