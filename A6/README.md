...
This folder contains Python scripts used for Assignment 6. A Python virtual environment is recommended. Install the required packages with:
...
1. **Extract PCAPs**: unzip the PCAP archives from `assignment_files/` into the `assignment_files/unpacked/` directory (already done).
...
This will generate output PDF in `report/report.pdf`.
