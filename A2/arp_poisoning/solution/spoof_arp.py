...
def get_mac(ip_address):
    ...
    answered, _ = srp(packet, timeout=2, iface=ATTACKER_INTERFACE, verbose=False)
    if answered:
...
if __name__ == "__main__":
    sniff_thread = None
    try:
        # Run sniffer before spoofing if preferred, or interleaved if needed.
